...
##############################################
class model(object):
    def __init__(self, word2id, embeddings, input_length, emb_size, output_size, trainable, layers=1, units=200):
        self.clf=Sequential()
...
#######################################################
class swem(object):
    def __init__(self, word_vectors, word2id, id2word, input_length, emb_size=300, output_size=3, trainable=True, layers=1, units=200):
        #Defined variables
        ...
        self.units=units
        #Defined model
        self.model_class= model(word2id, self.embeddings, input_length, emb_size, output_size,self.trainable, self.layers, self.units)
